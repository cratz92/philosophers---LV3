...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/11 11:51:23 by cbrito-l          #+#    #+#             */
/*   Updated: 2022/03/11 11:51:23 by cbrito-l         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int check_arguments(int argc, char **argv)
{
	...
	while (i < argc)
		if (ft_strisdigit(argv[i++]))
			return (error_msg("Wrong arguments\n"));
	if (ft_atoi(argv[1]) > 1000 || ft_strlen(argv[1]) > 4) //protecting arguments
		return (error_msg("Max nb of philosophers : 1000\n"));
	if (ft_atoi(argv[2]) > 1000000 || ft_strlen(argv[2]) > 7 || ft_atoi(argv[3]) > 1000000 || ft_strlen(argv[3]) > 7 || ft_atoi(argv[4]) > 1000000 || ft_strlen(argv[4]) > 7)
	...
	if (!ft_atoi(argv[2]) || !ft_atoi(argv[3]) || !ft_atoi(argv[4]) || (argv[5] && !ft_atoi(argv[5])))
